...
#define SUNXI_ACT_NAME "BU64241_act"
...
#define act_dev_err(x,arg...) printk(KERN_ERR"[ACT_ERR][BU64241_act]"x,##arg)

//print unconditional, for important info
#if ACT_DEV_DBG_EN == 1
#define act_dev_dbg(x,arg...) printk(KERN_INFO"[ACT][BU64241_act]"x,##arg)
#else
                            ...
                            unsigned short halfword, void* pt)
{
  ...
  data[0] = (unsigned char)((halfword>>12)&0x03|0xc4);//test
  data[1] = (unsigned char)(0xff&(halfword>>4));
...
MODULE_DESCRIPTION("BU64241 vcm actuator");
