...
static int sensor_s_gain(struct v4l2_subdev *sd, int gain_val)
{
	...
	unsigned short tmp_gain = 0;
	 ...
	 //	return 0;
	   ...
	   if (16<= gain_val && gain_val < (103*16/100) )
	      sensor_write(sd,0x3060,0x0000);
	   else if ((103*16/100) <= gain_val && gain_val < (107*16/100))
	      sensor_write(sd,0x3060,0x0001);
	   else if ((107*16/100) <= gain_val && gain_val < (110*16/100))
	      sensor_write(sd,0x3060,0x0002);
	   else if ((110*16/100) <= gain_val && gain_val < (114*16/100))
	      sensor_write(sd,0x3060,0x0003);
	   else if ((114*16/100) <= gain_val && gain_val < (119*16/100))
	      sensor_write(sd,0x3060,0x0004);
	   else if ((119*16/100) <= gain_val && gain_val < (123*16/100))
	      sensor_write(sd,0x3060,0x0005);
	   else if ((123*16/100) <= gain_val && gain_val < (128*16/100))
	      sensor_write(sd,0x3060,0x0006);
	   else if ((128*16/100) <= gain_val && gain_val < (133*16/100))
	      sensor_write(sd,0x3060,0x0007);
	   else if ((133*16/100) <= gain_val && gain_val < (139*16/100))
	      sensor_write(sd,0x3060,0x0008);
	   else if ((139*16/100) <= gain_val && gain_val < (145*16/100))
	      sensor_write(sd,0x3060,0x0009);
	   else if ((145*16/100) <= gain_val && gain_val < (152*16/100))
	      sensor_write(sd,0x3060,0x000a);
	   else if ((152*16/100) <= gain_val && gain_val < (160*16/100))
	      sensor_write(sd,0x3060,0x000b);
	   else if ((160*16/100) <= gain_val && gain_val < (168*16/100))
	      sensor_write(sd,0x3060,0x000c);
	   else if ((168*16/100) <= gain_val && gain_val < (178*16/100))
	      sensor_write(sd,0x3060,0x000d);
	   else if ((178*16/100) <= gain_val && gain_val < (188*16/100))
	      sensor_write(sd,0x3060,0x000e);
	   else if ((188*16/100) <= gain_val && gain_val < 2*16)
	      sensor_write(sd,0x3060,0x000f);
	   else if (2*16 <= gain_val && gain_val < (213*16/100))
	      sensor_write(sd,0x3060,0x0010);
	   else if ((213*16/100) <= gain_val && gain_val < (229*16/100))
	      sensor_write(sd,0x3060,0x0012);
	   else if ((229*16/100) <= gain_val && gain_val < (246*16/100))
	      sensor_write(sd,0x3060,0x0014);
	   else if ((246*16/100) <= gain_val && gain_val < (267*16/100))
	      sensor_write(sd,0x3060,0x0016);
	   else if ((267*16/100) <= gain_val && gain_val < (291*16/100))
	      sensor_write(sd,0x3060,0x0018);
	   else if ((291*16/100) <= gain_val && gain_val < (320*16/100))
	      sensor_write(sd,0x3060,0x001a);
	   else if ((320*16/100) <= gain_val && gain_val < (356*16/100))
	      sensor_write(sd,0x3060,0x001c);
	   else if ((356*16/100) <= gain_val && gain_val < (400*16/100))
	      sensor_write(sd,0x3060,0x001e);
	   else if ((400*16/100) <= gain_val && gain_val < (457*16/100))
	      sensor_write(sd,0x3060,0x0020);
	   else if ((457*16/100) <= gain_val && gain_val < (533*16/100))
	      sensor_write(sd,0x3060,0x0024);
	   else if ((533*16/100) <= gain_val && gain_val < (640*16/100))
	      sensor_write(sd,0x3060,0x0028);
	   else if ((640*16/100) <= gain_val && gain_val < (800*16/100))
	      sensor_write(sd,0x3060,0x002c);
	   else if ((800*16/100) >= gain_val )
