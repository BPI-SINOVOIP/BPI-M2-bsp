...
MODULE_DESCRIPTION("A low-level driver for GalaxyCore OV2640 sensors");
MODULE_LICENSE("GPL");
...
#define DEV_DBG_EN   		1
#if(DEV_DBG_EN == 1)
#define vfe_dev_dbg(x,arg...) printk("[CSI_DEBUG][OV2640]"x,##arg)
#else
#define vfe_dev_dbg(x,arg...)
#endif
#define vfe_dev_err(x,arg...) printk("[CSI_ERR][OV2640]"x,##arg)
#define vfe_dev_print(x,arg...) printk("[CSI][OV2640]"x,##arg)
...
static struct regval_list sensor_default_regs[] =
{
 ...
 //
    ...
    {{0x7c},{0x00}},
    {{0x7d},{0x02}},//0x00 peak//0x07,ȷ���ڱ���ļ���û������
    {{0x7c},{0x03}},
    {{0x7d},{0x28}},//0x48//0x40 ���ֵ�Ѿ���С��,�������ڱ���ļ�����д��
    {{0x7d},{0x28}},//0x48 peak//0x40 ���ֵ�Ѿ���С��,�������ڱ���ļ�����д��
...
static int sensor_init(struct v4l2_subdev *sd, u32 val)
{
	...
	ret = sensor_write(sd, 0xff, 0x01);
	if (ret < 0) {
	   vfe_dev_err("----sensor_write err at sensor_init !\n");
		return ret;
	}

	ret = sensor_write(sd, 0x3c, 0x3f);
	if (ret < 0) {
	   vfe_dev_err("sensor_write err at sensor_init !\n");
		return ret;
	}
