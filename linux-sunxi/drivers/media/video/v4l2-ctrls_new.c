...
//add by raymonxiu
	static const char * const auto_n_preset_wb[] = {
		"Manual",
		"Auto",
		"Incandescent",
		"Fluorescent",
	...
	static const char * const exposure_metering[] = {
		"Average",
		"Center Weighted",
		"Spot",
		NULL,
	...
	static const char * const auto_focus_range[] = {
		"Auto",
		"Normal",
		"Marco",
		"Infinity",
...
const char *v4l2_ctrl_get_name(u32 id)
{
	...
	//add by raymonxiu
	case V4L2_CID_COLORFX_CBCR:		return "Colorfx CbCr";
...
//	case V4L2_CID_CAMERA_AF_MODE:		return "AutoFocus Mode";
	...
	//add by raymonxiu
	case V4L2_CID_AUTO_EXPOSURE_BIAS:		return "AutoExposure Compensation";
	case V4L2_CID_AUTO_N_PRESET_WHITE_BALANCE:		return "AutoWhiteBalance Preset";
	...
	case V4L2_CID_AUTO_FOCUS_START:			return "Start AutoFocus";
	case V4L2_CID_AUTO_FOCUS_STOP:			return "Stop AutoFocus";
	case V4L2_CID_AUTO_FOCUS_STATUS:		return "Get AutoFocus Status";
	case V4L2_CID_AUTO_FOCUS_RANGE:			return "AutoFocus Range";
