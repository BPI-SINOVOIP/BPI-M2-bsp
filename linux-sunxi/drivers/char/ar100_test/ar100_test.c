...
static void __ar100_get_chipid_test(void)
{
	u32 i, j;
	u32 times;
	u32 total_time;
	...
	/* dump time information */
	printk("get chip id times %d: total time: %dus, once: %dus\n", times, total_time, total_time / times);
...
static int __ar100_test_thread(void * arg)
{
	...
	printk("ar100 get chip id test begin....\n");
	__ar100_get_chipid_test();
	printk("ar100 get chip id test end....\n");
