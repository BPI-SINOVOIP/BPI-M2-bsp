...
{
	0x02000e00,0x07050333,0x0bdd084f,0x0a000600,0x0f550b55,0x04aa00aa,0x02380000,//Hmax,Hmin
	0x01000000,0xff000000,0xff000000,0x01000000,0x01000000,0x01000000,0x01000000,//Vmax,Vmin
	0x0fff0001,0x0fff0000,0x0fff0000,0x0fff0000,0x0fff0000,0x0fff0000,0x0ae101a0 //Smax,Smin
};

__u32 hsv_adjust_vivid_par[16] = 
{
	0x00000000,0x068a0068,//Hgain_G,Sgain_G,Vgain_G
	0xff000000,0xff000000,0xff000000,0xff000000,0xff000000,0xff000000,0xff000000,//Hgain_L
	0x00000000,0x00b40000,0x00310000,0x00000000,0x00000000,0x00000000,0x00000000 //Sgain_L,Vgain_L
};
	...
	switch(mode)
	{
		...
		case 0x8://vivid mode
			...
			else
			{
				...
				CMU_WUINT32(sel,IMGEHC_CMU_GLOBAL_SVGAIN_REG_OFF, (((i_saturaion&0x1FFF)<<16)|0x68));
			}
			break;
